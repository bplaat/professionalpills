...
@section('title', __('trails.edit.title', ['trail.name' => $trail->name]))
...
@section('content')
    <div class="breadcrumb">
        <ul>
            ...
            <li><a href="{{ route('trails.show', $trail) }}">{{ $trail->name }}</a></li>
            <li class="is-active"><a href="{{ route('trails.edit', $trail) }}">@lang('trails.edit.breadcrumb')</a></li>
        </ul>
    </div>

    <h1 class="title">@lang('trails.edit.header')</h1>

    <form method="POST" action="{{ route('trails.update', $trail) }}">
        @csrf
        ...
        <div class="field">
            <label class="label" for="description">@lang('trails.edit.description')</label>
        ...
        <div class="field">
            <label class="label" for="limit">@lang('trails.edit.limit')</label>
        ...
        <div class="field">
            <div class="control">
                <button class="button is-link" type="submit">@lang('trails.edit.button')</button>
            </div>
        </div>
    </form>
@endsection
