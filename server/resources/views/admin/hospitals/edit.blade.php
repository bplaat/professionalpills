...
@section('content')
    <div class="breadcrumb">
        <ul>
            ...
            <li class="is-active"><a href="{{ route('admin.hospitals.edit', $hospital) }}">@lang('admin/hospitals.edit.breadcrumb')</a></li>
        </ul>
    </div>
    ...
    <form method="POST" action="{{ route('admin.hospitals.update', $hospital) }}">
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="address">@lang('admin/hospitals.edit.address')</label>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="postcode">@lang('admin/hospitals.edit.postcode')</label>
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="city">@lang('admin/hospitals.edit.city')</label>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="country">@lang('admin/hospitals.edit.country')</label>
